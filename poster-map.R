...
# This plot didnt work and only zoomed out a small amount compared to the original 
...
site_plot <- ggplot() +
  ...
  # Province Boundaries (All and specific Siem Reap)
  ...
  # Minimalist Compass and Scale
  annotation_north_arrow(location = "tr", style = north_arrow_minimal()) +
  annotation_scale(location = "bl", style = "ticks") +
  
  # FIXED ZOOM: Force the view to the bounding box
...
# Plotting this simplified version
p4 <- ggplot() +
